import { defaultMapperFactory, CompilerOptionsResolver, createVueLanguagePlugin, createLanguage, FileMap } from '@vue/language-core';
...
function createTwoslasher(createOptions = {}) {
  ...
  function getVueLanguage(compilerOptions, vueCompilerOptions) {
    ...
    function getLanguage() {
      ...
      const vueLanguagePlugin = createVueLanguagePlugin(ts, compilerOptions, vueOptions, (id) => id);
