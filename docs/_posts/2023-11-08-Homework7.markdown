...
const s1 = new Simulator(context, 10, 10 , intervals, trials, ABM)
s1.simulate()
</script>
...
const s1 = new Simulator(context, 10, 10 , intervals, trials, GBM)
s1.simulate()
</script>
...
const s1 = new Simulator(context, 10, 10 , intervals, trials, OU)
s1.simulate()
</script>
