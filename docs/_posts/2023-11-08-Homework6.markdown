...
class Simulator {
  constructor(context, x, y, N, M, success, failure, P, S) {
    ...
    this.box = new Rectangle(context, x, y, width, height)
    this.histogramMiddle = new Histogram(context, 2*N ,5, this.x + 350, this.y, 100, height)
    this.histogramLast = new Histogram(context, 2*N, 5, this.x + width, this.y, 100, height)
    this.calcIntervals()
  }
